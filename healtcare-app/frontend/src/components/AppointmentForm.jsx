...
export default function AppointmentForm({ doctors, patients, onCreate }){
  ...
  return (
    <form className="form" onSubmit={async e=>{
      e.preventDefault();
      await onCreate({ ...form, doctor_id:+form.doctor_id, patient_id:+form.patient_id });
    }}>
      ...
      <input className="full" type="datetime-local" value={form.start_time} onChange={e=>setForm({...form, start_time:e.target.value})} required />
