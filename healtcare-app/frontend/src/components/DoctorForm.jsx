...
export default function DoctorForm({ onCreate }){
  ...
  return (
    <form className="form" onSubmit={async e=>{ e.preventDefault(); await onCreate(form); setForm({first_name:'',last_name:'',specialty:''}) }}>
      ...
      <input className="full" placeholder="Specialità" value={form.specialty} onChange={e=>setForm({...form, specialty:e.target.value})} required />
